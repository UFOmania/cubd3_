...
/*   Updated: 2025/11/06 17:41:36 by ybassour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define W 2
# define E 3
# define CENTER_X_MOUSE 640
# define CENTER_Y_MOUSE 360
...
int				is_vertical_or_horizontal_door_hit(char **map, \
				float door_x, float door_y);
t_door			*get_target_door(t_game *game, int map_x, int map_y);
int				cast_ray_collect_doors(t_game *game, \
				float ray_angle, t_door_hit *hits);
